...
class MyOptions(PipelineOptions):
    ...
    def _add_argparse_args(cls, parser):
        parser.add_value_provider_argument('--input_pattern', type=str, help='Input file pattern')
...
with beam.Pipeline(options=options) as p:
    (p
     | 'Read JSON from GCS' >> ReadFromText(my_options.input_pattern)
